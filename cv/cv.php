...
<div class="Grid Grid--withGutter">
    ...
    <div><!-- must nest hero image to respect skinny- type margins -->
      <div class="CV">
        ...
        <ul>
          ...
          <li>
            <h3 class="u-mt-xl">Energy Intellect<span>Dec. 2001 – Sep. 2008</span></h3>
            <p class="u-mt-0"><b>Designer / Developer / Desktop Publisher</b></p>
        ...
        <h2 class="u-mt-xl">Education</h2>
        <ul>
          <li>
            <h3>Natcoll<span>Jul. 2000 – Mar. 2001</span></h3>
            <p class="u-mt-0"><b>Diploma of Multimedia</b></p>
            <dl>
  ...
  <div class="CV">
      <h2>Technologies</h2>
        ...
        <h2>Referees</h2>
        <p class='u-mt-md'>Please feel free to contact either of my referees.</p>
        <ul class="u-mt-sm">
          <li>
            <p>
              <b>Craig Eades</b><br>
